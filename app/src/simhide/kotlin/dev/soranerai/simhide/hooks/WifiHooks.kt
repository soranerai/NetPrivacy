...
import dev.soranerai.simhide.model.WifiProfile
import dev.soranerai.simhide.model.validationErrorRes
...
object TargetWifiHooks {
    ...
    private fun logHit(method: String) {
        if (loggedHits.add(method)) SimHideLog.info("first Wi-Fi policy hit: $method")
    }
}
