...
internal object RootPolicyPublisher {
    ...
    fun publish(source: File): Result<Unit> = runCatching {
        ...
        val command = "mkdir -p $DIRECTORY && chmod 0700 $DIRECTORY && cp ${source.absolutePath} $DIRECTORY/.policy.tmp && chown system:system $DIRECTORY/.policy.tmp && chmod 0640 $DIRECTORY/.policy.tmp && mv $DIRECTORY/.policy.tmp $TARGET"
